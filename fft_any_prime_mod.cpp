//fft mod any prime which may not fft friendly
// problem link: https://codeforces.com/contest/958/problem/F3
#include<bits/stdc++.h>
using namespace std;
...
vector<int> solve(int l, int r) {
	...
	int mi = (l + r) / 2;
	std::vector<int> v1 = solve(l, mi), v2 = solve(mi + 1, r);
	int sa = sum[r];
	if(l) sa -= sum[l - 1];
	v = multiply(v1, v2);
	while(v.size() > sa + 1) v.pop_back();
	return v;
}
int32_t main() {
